...
function startRitualLogic(useTouch = false, onComplete) {
    ...
    const visualInterval = setInterval(() => {
        ...
        deckCard.style.boxShadow = `
            0 0 ${30 * glowIntensity}px rgba(229, 160, 192, ${0.3 * glowIntensity}),
            inset 0 0 ${60 * glowIntensity}px rgba(229, 160, 192, ${0.1 * glowIntensity})
        `;
        ...
        if (shakeCount >= 20) { // 3秒后（20次 * 150ms = 3000ms）
            ...
            deckCard.style.boxShadow = '0 0 40px rgba(229, 160, 192, 0.5), inset 0 0 80px rgba(229, 160, 192, 0.2)';
